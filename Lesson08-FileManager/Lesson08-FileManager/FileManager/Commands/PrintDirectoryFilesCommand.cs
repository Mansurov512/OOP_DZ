...
public class PrintDirectoryFilesCommand : FileManagerCommand//вывод содержимого директории
{
    ...
    public override void Execute(string[] args)
    {
        ...
        _UserInterface.WriteLine($"Содержимое директории {directory}:");//выводим папки и файлы
